  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        {/* Success Message */}
        {successMessage && (
          <div className="mb-4 p-4 rounded-xl flex items-center gap-3" style={{ background: colors.success + '20' }}>
            <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: colors.success + '30' }}>
              <span className="text-lg">✓</span>
            </div>
            <p className="text-sm" style={{ color: colors.success }}>{successMessage}</p>
          </div>
        )}

        {/* Error Message */}
        {error && (
          <div className="mb-4 p-4 rounded-xl flex items-center gap-3" style={{ background: colors.danger + '20' }}>
            <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: colors.danger + '30' }}>
              <span className="text-lg">!</span>
            </div>
        ...
        <div className="space-y-4">
          ...
          {mode === 'signup' && (
            <div>
              ...
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: colors.textSecondary }} />
                <input
                  type="text"
                  value={username}
          ...
          <div>
            ...
            <div className="relative">
              <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: colors.textSecondary }} />
              <input
                type="email"
                value={email}
          ...
          <div>
            ...
            <div className="relative">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5" style={{ color: colors.textSecondary }} />
              <input
        ...
        <div className="mt-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-sm" style={{ color: colors.textSecondary }}>или</span>
            <div className="flex-1 h-px" style={{ background: colors.border }} />
          </div>
